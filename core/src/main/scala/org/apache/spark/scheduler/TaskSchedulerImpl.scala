  ...
  extends TaskScheduler with Logging
{
  ...
  //zengdan
  override def sendBenefit(benefit: scala.collection.mutable.Map[Int, BenefitInfo]): Unit = {
    backend.sendBenefit(benefit)
  }
  ...
  def resourceOffers(offers: Seq[WorkerOffer]): Seq[Seq[TaskDescription]] = synchronized {
    ...
    val shuffledOffers = Random.shuffle(offers).sortBy(_.host)  //zengdan add sortby
